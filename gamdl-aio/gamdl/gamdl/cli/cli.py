...
async def main(config: CliConfig):
    ...
    alac_codecs = {
        SongCodec.ALAC,
        SongCodec.ALAC_16_44,
        SongCodec.ALAC_24_44,
        SongCodec.ALAC_24_48,
        SongCodec.ALAC_24_96,
        SongCodec.ALAC_24_192,
    }
    if any(codec in config.song_codec_piority for codec in alac_codecs) and not config.use_wrapper:
        logger.warning(
