...
After cleanup-specific approval, remove only the recorded stranded private playlist as its owner, verify 404, then rerun the actor-bound throwaway lane. Finish Subsonic and WebSocket smoke afterward. Canvas UI source remains queued behind a GPL-compatible grant; do not recreate its effects locally.
