...
public sealed class JellyfinMusicEndpointPolicyTests
{
    ...
    [InlineData("GET", "/Sessions?ControllableByUserId=user-id")]
    [InlineData("POST", "/Sessions/session-id/Command")]
    [InlineData("POST", "/Sessions/session-id/Command/DisplayMessage")]
    [InlineData("POST", "/Sessions/session-id/Message")]
    [InlineData("POST", "/Sessions/session-id/Playing")]
    [InlineData("POST", "/Sessions/session-id/Playing/PlayPause")]
    [InlineData("POST", "/Sessions/session-id/System/GoHome")]
    [InlineData("POST", "/Sessions/session-id/Viewing")]
    [InlineData("POST", "/Sessions/Viewing")]
    ...
    [InlineData("DELETE", "/Sessions/session-id/User/user-id")]
    [InlineData("POST", "/Sessions/session-id/User/user-id")]
    [InlineData("GET", "/Sessions/session-id/Command")]
    [InlineData("POST", "/Sessions/session-id/Unknown")]
