...
| `VALKEY_MAX_MEMORY`, `REDIS_ENABLED`, `REDIS_CONNECTION_STRING` | Removed Valkey/cache deployment | Recognize and report these legacy inputs as obsolete. Do not import them or migrate disposable cache contents. |
