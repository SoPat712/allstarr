    ...
    {:else}
      ...
      <div class="intelligence-grid">
        <section class="panel recommendations">
          ...
          {:else}<div class="compact-empty"><strong>No recommendations yet</strong><p><a class="touch-link" href="#/sources">Connect or configure a source</a>, then refresh. Listening-based recommendations also need automatic history and completed plays.</p></div>{/if}
        </section>
