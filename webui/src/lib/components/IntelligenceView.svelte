...
<style>
  ...
  @media(max-width:620px){.intelligence-header{gap:.75rem}.route-heading-copy h2{margin-top:0;font-size:1.6rem}.heading-tools,.scope-value,.library-picker{width:100%}.scope-value{grid-template-columns:auto minmax(0,1fr);align-items:baseline;column-gap:.55rem;padding:.55rem .75rem}.scope-value small{grid-column:1}.scope-value strong,.scope-value span{grid-column:2}:global(.intelligence-tabs :is(a,button)){min-width:4.5rem;flex:1 0 4.5rem;padding-inline:var(--space-1);font-size:var(--text-xs)}.policy-basics,.run-progress{grid-template-columns:1fr}.policy-choices{gap:1rem}.provider-choices,.signal-choices{grid-template-columns:1fr}.provider-choices label,.signal-choices label,fieldset legend,fieldset>p{grid-column:1}.recommendation-list>li{grid-template-columns:auto minmax(0,1fr)}.track-actions{grid-column:2;flex-wrap:wrap}.automation-summary dl{grid-template-columns:1fr}.automation-summary dl div+div{border-top:1px solid var(--color-edge);border-left:0}.automation-summary>:global([data-slot="button"]){width:100%}.privacy-card footer{flex-direction:column-reverse}.privacy-card footer>:global([data-slot="button"]){width:100%}.touch-link{display:inline-flex;min-height:var(--control-md);align-items:center}}
</style>
