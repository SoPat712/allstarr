...
<style>
  .sound-discovery{display:grid;gap:1rem;padding:1.15rem}.sound-discovery,.sound-controls,.sound-form,.library-actions,.sound-results,.create-form,.sound-results li>div{min-width:0}.sound-discovery>header,.sound-results>header{display:flex;align-items:start;justify-content:space-between;gap:1rem}.sound-discovery h3{margin:.2rem 0}.sound-discovery>header p:last-child{max-width:48rem;margin:0;color:var(--color-ink-muted)}.scan-status{display:grid;grid-template-columns:minmax(0,1fr) minmax(12rem,.5fr);align-items:center;gap:1rem;border-top:1px solid var(--color-edge);padding-top:1rem}.scan-status small,.sound-results small{display:block;color:var(--color-ink-muted)}.sound-controls{display:grid;grid-template-columns:minmax(13rem,.4fr) minmax(0,1.6fr);align-items:end;gap:1rem;border-top:1px solid var(--color-edge);padding-top:1rem}.sound-form{display:flex;align-items:end;gap:.75rem}.sound-form .grow{flex:1}.library-actions{display:flex;gap:.75rem}.sound-results{display:grid;gap:.75rem;border-top:1px solid var(--color-edge);padding-top:1rem}.sound-results h4,.sound-results h5{margin:0}.sound-results ol{display:grid;margin:0;padding:0;list-style:none}.sound-results li{display:grid;grid-template-columns:2rem minmax(0,1fr);gap:.5rem;border-top:1px solid var(--color-edge);padding:.65rem 0}.sound-results li>span{color:var(--color-ink-muted);font-variant-numeric:tabular-nums}.sound-results strong,.sound-results small,.create-form p{overflow-wrap:anywhere}.sound-group{display:grid;gap:.5rem}.sound-group+ .sound-group{margin-top:.5rem}:global(.more-results){justify-self:start}.create-form{display:grid;grid-template-columns:minmax(12rem,.7fr) minmax(14rem,1fr) auto;align-items:end;gap:.75rem;border-top:1px solid var(--color-edge);padding-top:1rem}.create-form p{margin:0;color:var(--color-ink-muted)}
