...
{
    public Guid Id { get; set; } public Guid TenantId { get; set; } public Guid OwnerUserId { get; set; }
    ...
    public DateTimeOffset UpdatedAt { get; set; } public long Revision { get; set; }
}
public sealed class ListeningSignalRecord
{
    ...
    public string? SignalKey { get; set; } public Guid? SourceJobId { get; set; }
    public DateTimeOffset ObservedAt { get; set; } public DateTimeOffset ExpiresAt { get; set; }
}
public sealed class ListeningProfileRecord
{
    ...
    public DateTimeOffset WindowStart { get; set; } public DateTimeOffset WindowEnd { get; set; }
...
public sealed class RecommendationRunRecord
{
    ...
    public Guid? TargetCredentialReferenceId { get; set; }
    public RecommendationRunState State { get; set; } public string? ErrorCode { get; set; }
...
{
    public Guid Id { get; set; } public Guid RunId { get; set; } public Guid TenantId { get; set; }
    public Guid OwnerUserId { get; set; } public int Position { get; set; } public string TrackKey { get; set; } = "";
    public double Score { get; set; } public string Source { get; set; } = "";
...
{
    public Guid Id { get; set; } public Guid RunId { get; set; } public Guid TenantId { get; set; }
    public Guid OwnerUserId { get; set; } public string Protocol { get; set; } = "";
...
{
    public Guid Id { get; set; } public Guid GeneratedSetId { get; set; } public Guid TenantId { get; set; }
    public Guid OwnerUserId { get; set; } public int Position { get; set; } public string TrackKey { get; set; } = "";
